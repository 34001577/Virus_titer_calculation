...
source("https://raw.githubusercontent.com/34001577/Virus_titer_calculation/main/Titer_calculation_function_source_code.R?token=AV6KZKG47B7ITBYZSLOMLR3BLX63I")#you may need to update this directory to your R function script.
...
#                   subtitle =paste("Virus titer:",formatC(table$`Virus titer`[i], format='e', digits = 2)))+
